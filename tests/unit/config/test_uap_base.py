...
class TestUapPermissionFieldStringRepresentation:
    """Test UapPermissionField __str__() method."""

    def test_str_all_slots_enabled(self):
        """Test __str__ with all slots enabled."""
        field = UapPermissionField(0x0F)
        result = str(field)
        assert result == "slots[0,1,2,3]"

    def test_str_no_slots_enabled(self):
        """Test __str__ with no slots enabled."""
        field = UapPermissionField(0x00)
        result = str(field)
        assert result == "no_access"

    def test_str_some_slots_enabled(self):
        """Test __str__ with some slots enabled."""
        field = UapPermissionField(0x0A)  # Slots 1 and 3
        result = str(field)
...
class TestUapSingleFieldConfigPermissions:
    ...
    def test_permissions_setter_with_int(self):
        """Test permissions setter with integer value."""
        config = UapSingleFieldConfig(0x00000000)
        config.permissions = 0xCD
...
class TestUapDualFieldConfigCfgPermissions:
    ...
    def test_cfg_permissions_setter_with_int(self):
        """Test cfg_permissions setter with integer value."""
        config = UapDualFieldConfig(0x00000000)
        config.cfg_permissions = 0x34
...
class TestUapDualFieldConfigFuncPermissions:
    ...
    def test_func_permissions_setter_with_int(self):
        """Test func_permissions setter with integer value."""
        config = UapDualFieldConfig(0x00000000)
        config.func_permissions = 0x34
...
class TestUapMultiSlotConfigGetSetSlotField:
    ...
    def test_set_slot_field_with_int(self):
        """Test setting slot field with integer value."""
        config = UapMultiSlotConfig(0x00000000)
        config._set_slot_field(16, 0xCD)
